...
public:
  ...
  MDLLEXPORT const MCL_TCHAR * Data() const {return m_pData;}
...
public:
  ...
  virtual void Align(int bytes = 4) {}
...
public:
  ...
  inline void reshape(long, bool bChunk = false);
...
#define VALCHUNK 8192

template <class Item>
inline void TMValueVector<Item>::reshape(long length, bool bChunk)
{
  if (!bChunk) {
    Item * pNewArray;
    if (length > 0)
    ...
    if (length <= m_lengthAlloc) {
      m_length = length;
      return;
    }
    int chunk = 8192;
    m_lengthAlloc = (length/chunk+1)*chunk;
    Item * pNewArray;

    pNewArray = new Item[m_lengthAlloc];
...
public:
  ...
  MDLLEXPORT bool Tokenize(CMPtrStringList & result, const CMString & source, bool bNoRemoveMult = false);
...
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
class CMReadBufferStream : public IMReadStream
{
public:
    MDLLEXPORT CMReadBufferStream();
    MDLLEXPORT virtual ~CMReadBufferStream();

    MDLLEXPORT virtual bool Set(const char * pBuffer, int sizeInBytes);
    MDLLEXPORT bool Append(const char * pBuffer, int sizeInBytes);
    MDLLEXPORT void SetReserve(int reserve);
    MDLLEXPORT void Compact();
...
protected:
    ...
    virtual bool ReadBlob(void * pData, long lenInElements, long elSize);
    virtual bool ReadString(CMString & string);
    virtual bool ReadStringLine(CMString & string) {return ReadString(string);}
...
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
class CMWriteBufferStream : public IMWriteStream
{
public:
    MDLLEXPORT CMWriteBufferStream();
    MDLLEXPORT virtual ~CMWriteBufferStream();

    MDLLEXPORT virtual const char * Get() const;   
    MDLLEXPORT virtual int Size() const {return m_bytesProcessed;}
