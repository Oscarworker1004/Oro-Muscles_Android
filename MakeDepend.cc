/* Copyright (c) 2020 Methority AB. 
   This file is distributed under the MIT license (see license/LICENSE-Methority)
*/
						   ...
						   const string &source_tree_subdir )
{
  ...
  if (strstr(source_tree_subdir.c_str(), "Android") != NULL) {
    cout << "SKIPPING " << source_tree_subdir << endl;
    return;    
  }
