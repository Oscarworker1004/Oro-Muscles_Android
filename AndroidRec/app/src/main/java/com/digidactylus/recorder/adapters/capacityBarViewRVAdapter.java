...
public class capacityBarViewRVAdapter extends RecyclerView.Adapter<capacityBarViewRVAdapter.ViewHolder> {
    List<graphItemsList> list;
    Context context;
    public capacityBarViewRVAdapter(Context context, List<graphItemsList> list ){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Log.d("jklfdsfkldsfsdlkfds", String.valueOf(dpToPx(context, model.getBarBodyHeight())));
